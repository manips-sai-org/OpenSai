...
class RedisKeys:
    ...
    dog_current_position: str = "opensai::controller::Dog::::cartesian_task::current_position"
    dog_current_orientation: str = "opensai::controller::Dog::cartesian_controller::cartesian_task::current_orientation"
    dog_goal_position: str = "opensai::controller::Dog::cartesian_controller::cartesian_task::goal_position"
    dog_goal_orientation: str = "opensai::controller::Dog::cartesian_controller::cartesian_task::goal_orientation"
...
def MoveStart(startPos):

    desiredPos = startPos.copy()
    desiredPos[2] += 0.1
